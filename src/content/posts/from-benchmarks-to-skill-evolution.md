...
*D3-generated ordinal capability map. Shape and color jointly encode a green star for
native/first-class support, a yellow document for documented but non-native support, a
blue hand when a manual adapter is required, and a red X when the capability is
unsupported or outside framework scope. The map is a dated documentation synthesis,
not a benchmark score, and row totals are intentionally meaningless. ([Inspect AI](https://inspect.aisi.org.uk/),
...
![Unsupported][cap-unsupported] means not supported or outside framework scope. These
icons describe scope, not quality, and must not be summed into a rank. ([NVIDIA SkillEvaluator](https://github.com/NVIDIA/SkillEvaluator),
[Harbor](https://github.com/harbor-framework/harbor)).
...
[cap-native]: ../../assets/images/modern-skill-evaluation/capability-native.svg "Native / first-class support"
[cap-documented]: ../../assets/images/modern-skill-evaluation/capability-documented.svg "Documented, but not native"
[cap-adapter]: ../../assets/images/modern-skill-evaluation/capability-adapter.svg "Manual adapter required"
[cap-unsupported]: ../../assets/images/modern-skill-evaluation/capability-unsupported.svg "Not supported / outside framework scope"
