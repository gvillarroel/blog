...
def build_html(source: Path) -> str:
    ...
    # Chrome prints the Mermaid and D3 timeline SVGs directly. The dense D3 capability
    # map uses its PNG snapshot for deterministic typography and a compact PDF while
    # retaining the HTML/SVG sources in the companion bundle.
